# Cloud-Computing
This repo contain all about Cloud Computing and I tried to document my learnings of "Cloud computing with AWS" training which I did with Inernshala. First I will cover some theory part and at last I will make a project using AWS VPCs, EC2, RDS and database. Here is my certificate of this training.
# About
...
4. Cloud provider service: AWS/Azure/GCP
5. Containerisation: Docker
6. Infrastructure As a Code (IaaC)
7. CI/CD
5. Database
